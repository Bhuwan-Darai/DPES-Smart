...
export default function MenuScreen() {
  ...
  console.log("parent data", JSON.stringify(data, null, 2));
  console.log("parent error", JSON.stringify(error, null, 2));
  ...
  const menuItems = [
    {
      ...
      route: "(parentScreen)/profile" as const,
    },
    {
      icon: Calendar,
      title: "Attendance",
      subtitle: "Check your attendance record",
      route: "(parentScreen)/attendance" as const,
    },
    {
      icon: BookOpen,
      title: "Assignments",
      subtitle: "View pending assignments",
      route: "(parentScreen)/assignments" as const,
    },
    {
      icon: Clock,
      title: "Time Table",
      subtitle: "View your class schedule",
      route: "(parentScreen)/classRoutine" as const,
    },
    {
      icon: Settings,
      title: "Settings",
      subtitle: "App preferences and notifications",
      route: "(parentScreen)/settings" as const,
    },
    {
      icon: HelpCircle,
      title: "Help & Support",
      subtitle: "Get assistance and FAQs",
      route: "(parentScreen)/help" as const,
    },
    // {
    //   icon: BookOpen,
    //   title: "Saved Content",
      ...
      <ScrollView style={styles.content}>
        <View style={styles.profileCard}>
          ...
          {/* <Text style={styles.profileDetails}>
            Student ID: {data?.parentDetails?.gender}
          </Text> */}
        </View>
