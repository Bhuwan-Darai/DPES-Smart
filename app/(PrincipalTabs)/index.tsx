...
import TopBarPrincipal from "@/components/TopBarPrincipal";
  ...
  const menuItems = [
    {
      icon: CalendarCheck,
      label: "Teachers List",
      route: "(principalScreen)/teacherList",
    },
    {
      icon: ClipboardList,
      label: "Students List",
      route: "(principalScreen)/studentList",
    },
    { icon: Users, label: "Staff List", route: "(principalScreen)/staffList" },

    {
      icon: FileText,
      label: "Teacher Attendance",
      route: "(principalScreen)/teacherAttendance",
    },
    {
      icon: BarChart2,
      label: "Fee Analytics",
      route: "(principalScreen)/feeAnalytics",
    },
    // {
    //   icon: BookOpenCheckIcon,
    //   label: "Vaccation Homework",
    //   route: "(teacherScreen)/vaccationHomework",
    // },
    // { icon: Trophy, label: "Homework", route: "(teacherScreen)/homework" },
  ...
  const carouselData = [
    {
      ...
      title: "Welcome Back!",
      subtitle: "Check out your daily progress",
    },
    {
      id: 2,
      image:
      ...
      subtitle: "New courses available",
    },
    // {
    //   id: 3,
    //   image:
    ...
    //   subtitle: "Don't miss out on important dates",
    // },
  ];

  //   const { data, loading, error, refetch } = useQuery(GET_ALL_NEWSFEED_CATEGORIES);
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.welcomeCard}>
          <View style={styles.statsGrid}>
            <View style={styles.statItem}>
              <GraduationCap size={24} color="#FF9500" />
        ...
        <View style={styles.chipContainer}>
          ...
          <TouchableOpacity
            style={[styles.chip, styles.activeChip]}
            onPress={() => router.push("(teacherScreen)/calendar" as never)}
          >
                ...
                <View style={styles.noticeContent}>
                  ...
                  {/* <View style={styles.noticeFooter}>
                    <TouchableOpacity style={styles.noticeButton}>
                      <Text style={styles.noticeButtonText}>Read More</Text>
                    </TouchableOpacity>
                  </View> */}
                </View>
              </View>
