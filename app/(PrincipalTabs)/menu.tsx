  ...
  const menuItems = [
    {
      ...
      route: "(principalScreen)/profile" as const,
    },
    // {
    //   icon: Calendar,
    ...
    //   route: "(teacherScreen)/assignments" as const,
    // },
    {
      icon: GraduationCap,
      title: "Exam Routine",
      subtitle: "View your exam routine",
      route: "(principalScreen)/examRoutine" as const,
    },
    // {
    //   icon: Calendar,
    //   title: "Time Table",
    ...
    //   route: "(teacherScreen)/help" as const,
    // },
    // {
    //   icon: BookOpen,
    //   title: "Saved Content",
    //   subtitle: "View your saved content",
    //   route: "(teacherScreen)/menu" as const,
    // },
  ];
        ...
        <View style={styles.profileCard}>
          <View style={styles.profileImage}>
            <Text style={styles.profileInitials}>
              {principalDetails?.fullName}
            </Text>
          </View>
          <Text style={styles.profileName}>{principalDetails?.fullName}</Text>
          <Text style={styles.profileDetails}>
            Email: {principalDetails?.email}
          </Text>
        </View>
