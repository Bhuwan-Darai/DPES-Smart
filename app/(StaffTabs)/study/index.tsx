...
import { Book, FileText, Video, Clock, Play, FileCheck, Trophy, ChevronRight } from 'lucide-react-native';
...
export default function StudyScreen() {
  ...
  const [activeCategory, setActiveCategory] = useState<SubjectCategory>('school');
      ...
      chapters: [
        {
          ...
          progress: 80,
          materials: [
            { type: 'video', title: 'Introduction to Derivatives', duration: '15:30', id: 'derivatives' },
            { type: 'video', title: 'Integration Basics', duration: '20:45', id: 'integration' },
            { type: 'pdf', title: 'Practice Problems Set 1', id: 'practice-problems' },
        ...
        },
        {
          ...
          progress: 60,
          materials: [
            { type: 'video', title: 'Linear Equations', duration: '18:20', id: 'linear-equations' },
            { type: 'pdf', title: 'Algebraic Expressions Worksheet', id: 'algebra-worksheet' },
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text style={[styles.tabText, activeCategory === 'school' && styles.activeTabText]}>
            School
          </Text>
        </Pressable>
        <Pressable
        ...
        >
          <Text style={[styles.tabText, activeCategory === 'others' && styles.activeTabText]}>
            Others
          </Text>
        </Pressable>
      </View>
      ...
      <ScrollView style={styles.content}>
        {subjects.filter(subject => subject.category === activeCategory).map(subject => (
                        ...
                        {chapter.materials.map((material, index) => (
                          ...
                          >
                            ...
                            <View style={styles.materialInfo}>
                              ...
                              {material.duration && (
                                <Text style={styles.materialMeta}>Duration: {material.duration}</Text>
                              )}
                              {material.questions && (
                                <Text style={styles.materialMeta}>{material.questions} Questions</Text>
                              )}
                            </View>
                          </TouchableOpacity>
                        ))}
