  ...
  const menuItems = [
    {
      icon: BookOpen,
      label: "Seat Plans",
      route: "(teacherScreen)/seatPlan",
    },
    { icon: Calendar, label: "Schedule", route: "(mainScreen)/schedule" },
    {
      icon: CheckCheckIcon,
      label: "Make Attendance",
      route: "(teacherScreen)/makeAttendance",
    },
    { icon: FileText, label: "Quizzes", route: "(mainScreen)/quizzes" },
    {
    ...
    { icon: Trophy, label: "Homework", route: "(teacherScreen)/homework" },
    {
      icon: NotebookText,
      label: "Add Result",
      route: "(teacherScreen)/addResult",
    },
    {
      icon: ClipboardList,
      label: "Result Ledger",
      route: "(teacherScreen)/resultLedger",
    },
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.welcomeCard}>
          {userDetails?.name && <Welcome userName={userDetails?.name} />}
        </View>
