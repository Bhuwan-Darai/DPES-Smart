...
import { GET_SCHOOL_CURRICULUM_LESSON_PLAN_FOR_TEACHER } from "@/lib/hooks/graphql/TeacherQueries";
...
export default function StudyDetailScreen() {
  ...
  const { data, loading, error } = useQuery(
    GET_SCHOOL_CURRICULUM_LESSON_PLAN_FOR_TEACHER,
    {
      variables: { subjectId: id, classId: classId },
      skip: !id || !classId,
    }
  );

  console.log(
    "teacherCurriculumDetailsofClasss",
        ...
        <View style={styles.lessonPlanHeader}>
          ...
          <View style={styles.lessonPlanHeaderRight}>
            ...
            <TouchableOpacity
              ...
              onPress={() => editLessonPlan(plan)}
            >
              <Text style={styles.viewDetailsButtonText}>Edit</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.viewDetailsButton}
          ...
          >
            <View style={styles.modalOverlay}>
              <View style={styles.modalContent}>
                <Text style={styles.modalTitle}>Edit Lesson Plan</Text>
                <TouchableOpacity onPress={closeEditModal} style={styles.closeButton}>
                  <Text style={styles.closeButtonText}>✕</Text>
                </TouchableOpacity>
                <View style={styles.modalBody}>
                <Text>Lesson Plan Details</Text>
                <Text>Duration</Text>
                <Text>Activities</Text>
                <Text>Teaching Method</Text>
  ...
  const editLessonPlan = (plan: LessonPlan) => {
    setSelectedLessonPlan(plan);
  ...
  const curriculumData: CurriculumHeader[] =
    data?.getSchoolCurriculumLessonPlanForTeacher || [];

  if (curriculumData.length === 0) {
    return (
      <View style={styles.container}>
        <Text style={styles.emptyText}>No curriculum data available</Text>
      </View>
    );
  }
          ...
          <View key={header.headerId} style={styles.headerContainer}>
            ...
            {header.lessonPlan.length > 0 && (
              <View style={styles.lessonPlanContainer}>
                <Text style={styles.lessonPlanTitle}>Header Lesson Plans:</Text>
