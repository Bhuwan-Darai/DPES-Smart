...
export default function AssignmentsScreen() {
  ...
  useEffect(() => {
    if (data?.getAssignmentsForStudent) {
      const allAssignments = data.getAssignmentsForStudent;
  ...
  }, [data?.getAssignmentsForStudent]);

  console.log("assignments from student", JSON.stringify(assignments, null, 2));
    ...
    try {
      ...
      if (result.assets && result.assets.length > 0) {
        ...
        const uploadPromises = result.assets.map(async (file) => {
          ...
          const folderPath = `assignments/${assignment.assignmentId}`;
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          {loading ? (
            ...
            <Text style={styles.noAssignmentsText}>No pending assignments</Text>
          )}
        </View>
