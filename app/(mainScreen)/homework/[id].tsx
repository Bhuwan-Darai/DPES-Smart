...
import { Homework, File, Submission } from "../homework";
...
export default function HomeworkDetailScreen() {
  ...
  const handleSubmitVacationHomework = async () => {
    try {
      ...
      if (result.assets && result.assets.length > 0) {
        ...
        const dataToSend = {
          vacationId: homeworkData.vacationId,
      ...
      {!isSubmitted && (
        <View style={styles.card}>
          ...
          <TouchableOpacity
            ...
            onPress={handleSubmitVacationHomework}
          ...
          >
            ...
            <Text style={styles.submitButtonText}>
              {submitAssignmentLoading ? "Submitting..." : "Submit Homework"}
            </Text>
          </TouchableOpacity>
        </View>
      )}
