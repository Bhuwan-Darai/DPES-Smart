import { GET_EXAM_ROUTINE } from "@/lib/hooks/graphql/TeacherQueries";
...
const ExamClassWise = () => {
  ...
  const {
    data: examRoutine,
    loading: examRoutineLoading,
    error: examRoutineError,
  } = useQuery(GET_EXAM_ROUTINE, {
    variables: {
      classId: classId,
      examId: id,
    },
  ...
  const routine = examRoutine?.getExamRoutine?.data as ExamRoutine;
  ...
  console.log(JSON.stringify(examRoutine, null, 2), "examRoutine");
