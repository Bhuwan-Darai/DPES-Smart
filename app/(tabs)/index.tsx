    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.chipContainer}>
          ...
          <TouchableOpacity
            style={[styles.chip, styles.activeChip]}
            onPress={() => router.push("(mainScreen)/calendar" as never)}
          >
