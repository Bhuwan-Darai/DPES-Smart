...
export default function TopBarParents() {
  ...
  const parentDetails = data?.getParentDetailsByAuthId?.data;
    ...
    <View style={styles.container}>
      ...
      <View style={styles.profileSection}>
        ...
        <View style={styles.textInfo}>
          <Text style={styles.name}>{parentDetails.guardianName}</Text>
          <Text style={styles.details}>
            Email: {parentDetails.guardianEmail}
          </Text>
        </View>
      </View>
